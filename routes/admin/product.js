...
router.post('/doAdd',function(req,res){
    ...
    form.uploadDir='F:\\新建文件夹 (2)\\v18dyy\\static\\upload'   //上传图片保存的地址     目录必须存在
...
router.post('/doEdit',function(req,res){
    ...
    form.uploadDir='F:\\新建文件夹 (2)\\v18dyy\\static\\upload'  // 上传图片保存的地址
